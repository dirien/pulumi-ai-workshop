...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-argocd-component/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("git://github.com/dirien/pulumi-ai-workshop-components"))
	version := semver.MustParse("0.0.0-xee7e738f1ec04447ff13e61523c646a80f74fc1b")
